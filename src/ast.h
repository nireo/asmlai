...
public:
  ...
  valuetype ValueType() const noexcept { return assingment_type_; }
...
public:
  ...
  valuetype ValueType() const noexcept { return value_type; }
...
public:
  ...
  valuetype ValueType() const noexcept { return TYPE_PTR_CHAR; }
...
public:
  ...
  valuetype ValueType() const noexcept { return inner_->ValueType(); }
...
public:
  ...
  valuetype ValueType() const noexcept { return identifier_->ValueType(); }
